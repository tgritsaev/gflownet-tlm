...
@dataclass
class DQNConfig(StrictDataClass):
    """SoftDQN config.
    ...
    leaf_coef: float = 10
    rb_size: int = 1_000_000
    per_alpha: float = 0.9
    per_beta: float = 0.1

    update_target_every: int = 0
    tau: float = 0.9
    is_dueling: bool = True
    munchausen_alpha: float = 0.15
    munchausen_l0: float = -650
...
class AlgoConfig(StrictDataClass):
    ...
    train_random_action_prob_annealing_policy: str = ""
    train_random_action_prob_exp: float = 0.2
